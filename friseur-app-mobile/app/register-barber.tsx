...
export default function RegisterBarberScreen() {
  ...
  async function handleRegisterBarber() {
    ...
    if (!acceptedTerms) {
      Alert.alert("Fehler", "Bitte akzeptiere die Nutzungsregeln.");
      return;
    }
    ...
    try {
      ...
      const res = await api.post("/auth/register-barber", {
        name: name.trim(),
      ...
      console.log("REGISTER BARBER ERROR FULL:", err);
      console.log("REGISTER BARBER ERROR MESSAGE:", err?.message);
      console.log("REGISTER BARBER ERROR RESPONSE:", err?.response?.data);
      console.log("REGISTER BARBER ERROR STATUS:", err?.response?.status);
        ...
        >
          ...
          <View style={styles.card}>
            <View style={styles.field}>
              <Text style={styles.label}>Name / Friseurname</Text>
              <TextInput
